    ...
    <section className={styles.pilot} aria-label={`${characterName} Character Detail V2.2`}>
      <section className={styles.overview} id="pilot-overview">
        <div className={styles.overviewLead}>
          ...
          <div className={styles.previewNote}>RCプレビューで表示を確認しています。攻略候補の公開状態は変更していません。</div>
        </div>
      ...
      <section className={styles.gameplan} aria-labelledby="pilot-gameplan-heading">
        <div className={styles.sectionTitle}><p className="eyebrow">基本方針</p><h2 id="pilot-gameplan-heading">基本の勝ち筋</h2><p>何を使うか、どの距離で使うか、何に注意するかを順番に確認します。</p></div>
      ...
      <section className={styles.moveSection} id="pilot-moves" aria-labelledby="pilot-moves-heading">
        <div className={styles.subheading}>
          <div>
            ...
            <p>クラシックとモダンを分け、確認済みの発生・ガード時・ダメージを表示します。未確認の数値は空欄を推測で補いません。</p>
          </div>
      ...
      <section className={styles.comboSection} id="pilot-combos" aria-labelledby="pilot-combos-heading">
        <div className={styles.subheading}><div><p className="eyebrow">コンボ</p><h2 id="pilot-combos-heading">まず確認するコンボ</h2><p>用途と消費ゲージを一覧で比べ、詳細をその場で展開できます。</p></div><Link href={appendDevicePreviewToken(`/characters/${characterSlug}/combos`, previewToken)}>すべて確認する →</Link></div>
      ...
      <section className={styles.strategySplit}>
        <div id="pilot-setplay">
          <div className={styles.subheading}><div><p className="eyebrow">セットプレイ</p><h2>セットプレイ</h2><p>文章ではなく、起点からの手順で確認します。</p></div><Link href={appendDevicePreviewToken(`/characters/${characterSlug}/setups`, previewToken)}>一覧 →</Link></div>
        ...
        <div id="pilot-sequences">
          <div className={styles.subheading}><div><p className="eyebrow">連携</p><h2>連携・対策</h2><p>入力、目的、注意点を一つずつ展開します。</p></div><Link href={appendDevicePreviewToken(`/characters/${characterSlug}/sequences`, previewToken)}>一覧 →</Link></div>
