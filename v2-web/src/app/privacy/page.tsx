    ...
    <div className="site-shell page-stack">
      ...
      <section>
        ...
        <p>
          ...
          お問い合わせフォームでは、種類、内容、返信先メールアドレス、任意で入力した対象ページURLを取得します。
          ログイン中に送信した場合は、利用中のアカウントを識別する情報を関連付けます。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          利便性向上、お問い合わせへの対応、迷惑送信の防止のために必要な範囲で利用します。
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          お問い合わせデータと、IPアドレスを復元できない形にした迷惑送信対策用の識別情報は、送信から180日以内に削除します。
        </p>
      </section>
