...
test("Phase23 Combo public gate quarantines non-actionable placeholders", () => {
  const sql = read("../supabase/migrations/20260831_phase23_combo_publication_hardening.sql");
...
test("Phase23 Combo publication trigger rejects placeholder publication", () => {
  const sql = read("../supabase/migrations/20260831_phase23_combo_publish_trigger.sql");
